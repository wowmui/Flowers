...
namespace Kappa
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            菜单 = new Menu("Twisted Fate", "flowersKappa", true);
          ...
          //  菜单.SubMenu("Misc").AddItem(new MenuItem("tj", "Use W Anti GapCloser")).SetValue(true);
            菜单.SubMenu("Misc").AddItem(new MenuItem("AutoYellow", "Yellow Card stun with Uit").SetValue(true));
            ...
            菜单.SubMenu("Draw").AddItem(new MenuItem("drawingAA", "Real AA Range(OKTW© Style)").SetValue(true));
